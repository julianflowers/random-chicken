...
## kmeans
```{r} 
  e <- eclust(diabetess, k = 4, FUNcluster = "kmeans", seed = seed , graph = TRUE)
  
factoextra::fviz_cluster(e, repel = TRUE, ellipse.type = "convex", ellipse = TRUE, ellipse.level = .99, labelsize = 4)
